...
| 版本 | 日期 | 说明 |
|------|------|------|
| **v2.0.6** | 2026-06-29 | 修复示例和安装说明，增强 boundary-guard，增加专家真实性声明 |
| **v2.0.5** | 2026-06-29 | 清理 README 和 changelog 中的外部平台引用，统一使用 GitHub 作为安装来源 |
| **v2.0.4** | 2026-06-29 | 调整能力圈边界策略为「前置说明 + 免责声明」，仅紧急危机场景直接拒绝 |
